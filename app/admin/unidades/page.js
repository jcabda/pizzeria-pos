...
import { Plus, Edit2, Trash2, RefreshCw, Search, X, Check, Scale } from 'lucide-react'
...
export default function UnidadesPage() {
    ...
    const handleEliminarPermanente = async (id) => {
        if (!confirm('⚠️ ¿Estás seguro de ELIMINAR PERMANENTEMENTE esta unidad?')) return
        ...
        try {
            ...
            if (error) throw error
            alert('✅ Unidad eliminada permanentemente')
            cargarUnidades()
        } catch (error) {
        ...
        <DashboardLayout>
            <div className="space-y-6">
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <button onClick={cargarUnidades} className="btn-secondary text-sm flex items-center gap-1">
                        <RefreshCw size={16} />
                    </button>
                </div>
                                            ...
                                            <td className="px-4 py-3 space-x-2">
                                                {unidad.activo ? (
                                                    <>
                                                        ...
                                                        <button
                                                            onClick={() => handleEliminarPermanente(unidad.id)}
